kind load docker-image audi-skripsi-lambda-event-presenter:1.2.0 --name audi-skripsi
kind load docker-image audi-skripsi-lambda-batch-processor:1.0.1 --name audi-skripsi
